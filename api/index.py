...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "AD8B8" # Playfab Title Id
        self.SecretKey: str = "K1PTADUY6T63TAKKS6O1NEHYBMU9U53YXH38YX9G8EMMJHIZ9N" # Playfab Secret Key
        self.ApiKey: str = "OC|9402735573162915|579ca4879c2f42ab3555a2a56efc407a" # App Api Key
...
def main():
    return "Gimme credits in the motd for this backend yo"
...
def titledata():
    response_data = {
        ...
        "BundleBoardSign": "<color=#ff4141>DISCORD.GG/HYPERTAG</color>",
        "BundleKioskButton": "<color=#ff4141>DISCORD.GG/HYPERTAG</color>",
        "BundleKioskSign": "<color=#ff4141>DISCORD.GG/HYPERTAG</color>",
        "BundleLargeSign": "<color=#ff4141>DISCORD.GG/HYPERTAG</color>",
        ...
        "TOBAlreadyOwnPurchaseBundle": "DISCORD.GG/HYPERTAG",
        "TOBDefCompTxt": "DISCORD.GG/HYPERTAG",
        "TOBDefPurchaseBtnDefTxt": "DISCORD.GG/HYPERTAG",
        "UseLegacyIAP": False
...
def GetNameIg():
    return jsonify({"result": f"NTAG{random.randint(1000,9999)}"})
